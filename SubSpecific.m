...
%%
% 3 rounds of circle
circle_1 = Person1.data.Circle(:,[1,3])';
circle_2 = Person1.data.Circle(:,[5,7])';
circle_3 = Person1.data.Circle(:,[9,11])';

% 3 rounds of triangle
triangle_1 = Person1.data.Triangle(:,[1,3])';
triangle_2 = Person1.data.Triangle(:,[5,7])';
triangle_3 = Person1.data.Triangle(:,[9,11])';

% 3 rounds of left to right
horizontal_1 = Person1.data.Right(:,[1,3])';
horizontal_2 = Person1.data.Right(:,[5,7])';
horizontal_3 = Person1.data.Right(:,[9,11])';

% 3 rounds of up-down
vertical_1 = Person1.data.Down(:,[1,3])';
vertical_2 = Person1.data.Down(:,[5,7])';
vertical_3 = Person1.data.Down(:,[9,11])';
...
%circle network
network_circle = timedelaynet(delay,hidden_layer,'trainbr');
...
%triangle network
network_triangle = timedelaynet(delay,hidden_layer,'trainbr');
...
%horizontal network
network_horizontal = timedelaynet(delay,hidden_layer,'trainbr');
...
%vertical network
network_vertical = timedelaynet(delay,hidden_layer,'trainbr');
...
network_1 = [network_F1, network_F2, network_F3];
H = cat(3,H_F1, H_F2, H_F3);
ezroc3(H,[],2,'Person1',1);
filename = strcat('Person1.mat');
save(filename,'network_1');