...
for delay_v = 20:10:40
    for hidden_layer = 10:10:30
        delay = 1:delay_v;
        
        %circle network
        network_c = timedelaynet(delay, hidden_layer, 'trainbr');
        ...
        %triangle network
        network_t = timedelaynet(delay, hidden_layer, 'trainbr');
        ...
        %horizontal network
        network_h = timedelaynet(delay, hidden_layer, 'trainbr');
        ...
        %vertical network
        network_v = timedelaynet(delay, hidden_layer, 'trainbr');
        ...
        for j = 1:5
            ...
            network_c = train(network_c, Xsc, Tsc, Xic);
            ...
            network_t = train(network_t, Xst, Tst, Xit);
            ...
            network_h = train(network_h, Xsh, Tsh, Xih);
            ...
            network_v = train(network_v, Xsv, Tsv, Xiv);
        ...
        ezroc3(H,[],2,'',1);
        filename = strcat('net_d',num2str(delay_v),'_h',num2str(hidden_layer),'.mat');
